# Learnings — test-data-generator

Role-scoped operational lessons for the **test-data-generator** agent. Read at activation by the `recall-learnings` skill. Append-only.
