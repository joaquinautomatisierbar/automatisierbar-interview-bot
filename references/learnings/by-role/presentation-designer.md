# Learnings — presentation-designer

Role-scoped operational lessons for the **presentation-designer** agent. Read at activation by the `recall-learnings` skill. Append-only.
