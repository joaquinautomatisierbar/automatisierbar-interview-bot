...
- [x] 2.3 Primer + Quiz Modul 2 Cybersecurity/IT-Infra FERTIG (C, 10.7., 10 Tage vor Soll) → upskilling/modul-2-primer.md + modul-2-quiz.md; enthält die E4-Zahlen für die Scope-Session; S3-Owner Joaquin. **12.7.: Session-Kit komplett** → modul-2-deck.html (22 Folien, 60 min, Referentennotizen mit T+Markern = Joaquins Spickzettel, 3 [SKIP]-Folien) + modul-2-handout.md/.pdf (Spickzettel + Hausaufgabe Sicherheits-Audit am EIGENEN Gerät/Konten, bewusst nicht Claude-delegierbar, **Abgabe Mi 15.7. 18:00** via Hub-Upload); alles LIVE im Hub unter Lernen → Modul 2
