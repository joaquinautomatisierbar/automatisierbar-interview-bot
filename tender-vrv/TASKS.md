...
- [x] 2.3 Primer + Quiz Modul 2 Cybersecurity/IT-Infra FERTIG (C, 10.7., 10 Tage vor Soll) → upskilling/modul-2-primer.md + modul-2-quiz.md; enthält die E4-Zahlen für die Scope-Session; S3-Owner Joaquin. **12.7.: Session-Kit komplett, v2 nach Joaquin-Feedback komplett neu aufgebaut** → modul-2-deck.html (57 Kern-Folien + 5 Anhang, YouTube-Stil: ein Gedanke pro Folie, kein Begriff vor seiner Einführung, Angriffs-Story in 5 Szenen als roter Faden, wiederkehrende 4-Ringe-Landkarte, Decode der Original-Ausschreibungszeilen als Payoff; Referentennotizen = komplettes Sprech-Skript mit Übergängen + T+Markern, 1 Notfall-Skip F36) + modul-2-handout.md/.pdf v2 (Story-Absatz, Spickzettel nach Ringen, Audit-Aufgaben nach Ringen strukturiert; Hausaufgabe Sicherheits-Audit am EIGENEN Gerät/Konten, bewusst nicht Claude-delegierbar, **Abgabe Mi 15.7. 18:00** via Hub-Upload); alles LIVE im Hub unter Lernen → Modul 2
...
- [x] 2.6 Primer + Quiz Modul 5 Projektleitung/Offerten FERTIG (C, 10.7., 20 Tage vor Soll) → upskilling/modul-5-primer.md + modul-5-quiz.md (Phasenmodell als Vertragslogik, 6 PL-Artefakte, RACI, CR-Prozess, S6-Entscheid-Agenda: Rollen 4.2 + SLA-Validierung + Preismodell-Eckwerte); S6-Owner Joaquin. **ALLE 6 Modul-Primer + Quizzes damit fertig; Sessions können starten, sobald 2.0 Termine stehen** **12.7.: Session-Kit komplett (Session-Termin fixiert: Do 30.7.)** → modul-5-deck.html (Skelett v3: Morph-Übergänge + Klick-Builds + Aurora-Look statt Terminal; 51 Lehr-Folien mit Horror-Story in 5 Szenen als roter Faden + 17 Entscheidungs-Dossier-Folien mit Optionen/Pro-Contra/Herleitung/Empfehlung je S6-Entscheid + 5 Anhang) + modul-5-handout.md/.pdf (Hausaufgabe = echter Statusreport über die eigene Vorbereitungswoche, Pflicht-Lesetermin Generalprobe 3.8., + CR + Generalprobe-Messkriterien; **Abgabe So 2.8., 18:00** via Hub-Upload); alles LIVE im Hub unter Lernen → Modul 5
